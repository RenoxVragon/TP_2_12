...
void print_main_menu()
{
	...
	cout << "8. Узнать оператора абонента в интернете." << endl;
...
void menu_selection(int number)
{
	...
	case 8:
		if (keeper.get_size() > 0)
		{
			...
			cout << "Выберите индекс объекта, оператора которого хотите узнать: " << endl;
			index = process_choice(0, keeper.get_size() - 1);
			web_task(keeper[index].get_number());
		}
		else
